    ...
    <div id="app">
        ...
        <main class="py-4">
            <div class="container">
                ...
                <div>
                    <a href="{{route('kasir.pembelian.data.filter.cetak',$until)}}" class="btn btn-success mb-3">Cetak</a>
                    <a href="{{route('kasir.pembelian.data')}}" class="btn btn-info mb-3 text-white">Refresh</a>
                    <a href="{{route('kasir.home')}}" class="btn btn-secondary mb-3 text-white">Home</a>
                </div>
                <form method="POST" action="{{route('kasir.pembelian.data.filter')}}">
                    @csrf
                <div class="form-row">
