        ...
        <main class="my-5">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="{{route('manager.buku.takterjual.cetak')}}" class="btn btn-success mb-3">Cetak</a>
                        <a href="{{route('manager.home')}}" class="btn btn-secondary mb-3">Kembali</a>
                        <a href="{{route('manager.buku.takterjual')}}" class="btn btn-info mb-3 text-white">Refresh</a>
                    </div>
                    <form class="form-inline mb-3" action="{{route('manager.buku.takterjual.search')}}" method="POST">
                        @csrf
