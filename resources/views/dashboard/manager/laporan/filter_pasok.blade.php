        ...
        <main class="py-4">
            ...
            <div class="container px-4">
                <div class="dropdown bg-muted px-3 py-3 text-center">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        @foreach ($data as $dt)
                            <a class="dropdown-item h5" href="{{ route('manager.filter.pasok.result',$dt->nama_distributor) }}">{{$dt->nama_distributor}}</a>
                        @endforeach
                    </div>
                </div>
                <img src="/img/distributor.svg" alt="admin" width="300" class="d-block mx-auto my-4">
            </div>
        </main>
    </div>
</body>
