...
<body>
    <div id="app">
        ...
        <main class="py-4">
            <div class="container">
                <a href="{{route('manager.filter.penulis.cetak',$penulis)}}" class="btn btn-success mb-3">Cetak</a>
                <a href="{{route('manager.filter.penulis')}}" class="btn btn-secondary mb-3">Kembali</a>
