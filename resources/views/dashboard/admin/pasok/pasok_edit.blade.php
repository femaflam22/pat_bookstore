    ...
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="container px-4">
                <form method="POST" action="{{ route('admin.pasok.update',$data->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <option>{{$data->distributor['kode_distributor']}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="jumlah" id="jumlah" type="number" placeholder="Masukkan jumlah pasok dalam pcs" value="{{ $data->jumlah }}">
                    ...
                    <a href="{{ route('admin.pasok') }}" class="btn btn-info text-white text-decoration-none">Kembali</a>
                </form>
                <hr class="my-5">
            </div>
        </main>
