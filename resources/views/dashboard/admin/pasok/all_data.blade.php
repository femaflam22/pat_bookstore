    ...
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="container">
                ...
                <div>
                    <a href="{{route('admin.pasok.cetak')}}" class="btn btn-success mb-3">Cetak</a>
                    <a href="{{route('admin.pasok.data')}}" class="btn btn-info mb-3 text-white">Refresh</a>
                </div>
                <form method="POST" action="{{route('admin.pasok.data.search')}}">
                    @csrf
                <div class="form-row">
