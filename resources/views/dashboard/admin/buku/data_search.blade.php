        ...
        <main class="my-5">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="{{route('admin.buku.data_search.cetak',$search)}}" class="btn btn-success mb-3">Cetak</a>
                        <a href="{{route('admin.home')}}" class="btn btn-secondary mb-3">Kembali</a>
                        <a href="{{route('admin.buku.data')}}" class="btn btn-info mb-3 text-white">Refresh</a>
                        <a href="{{route('admin.buku.data.order')}}" class="btn btn-info mb-3 text-white">Urutkan Stok</a>
                    </div>
                    <form class="form-inline mb-3" action="{{route('admin.buku.data.search')}}" method="POST">
                        @csrf
