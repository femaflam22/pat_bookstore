    ...
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="container px-4">
                <form method="POST" action="{{ route('admin.buku.add') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="judul" value="{{ old('judul') }}" name="judul" placeholder="Masukkan judul buku">
                        <span class="text-danger mt-2">@error('judul'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="noisbn">No ISBN</label>
                        <input type="text" class="form-control" id="noisbn"  name="noisbn" value="{{ old('noisbn') }}" placeholder="Masukkan No ISBN buku">
                        <span class="text-danger mt-2">@error('noisbn'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="penulis">Penulis</label>
                        <input class="form-control" name="penulis" id="penulis" type="text" placeholder="Masukkan nama penulis" value="{{ old('penulis') }}">
                        <span class="text-danger mt-2">@error('penulis'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="penerbit">Penerbit</label>
                        <input class="form-control" name="penerbit" id="penerbit" type="text" value="{{ old('penerbit') }}" placeholder="Masukkan nama penerbit">
                        <span class="text-danger mt-2">@error('penerbit'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="tahun">Tahun</label>
                        <input type="number" class="form-control" id="tahun" value="{{ old('tahun') }}" placeholder="Masukkan tahun terbit buku" name="tahun">
                        <span class="text-danger mt-2">@error('tahun'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="stok">Stok</label>
                        <input type="number" class="form-control" id="stok" value="{{ old('stok') }}" name="stok" placeholder="Masukkan stok dalam pcs">
                        <span class="text-danger mt-2">@error('stok'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="harga_pokok">Harga Pokok</label>
                        <input type="number" class="form-control" id="harga_pokok"  name="harga_pokok" value="{{ old('harga_pokok') }}" placeholder="Harga tanpa titik (80000)">
                        <span class="text-danger mt-2">@error('harga_pokok'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="harga_jual">Harga Jual</label>
                        <input type="number" class="form-control" id="harga_jual"  name="harga_jual" value="{{ old('harga_jual') }}" placeholder="Harga tanpa titik (80000)">
                        <span class="text-danger mt-2">@error('harga_jual'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="ppn">PPN</label>
                        <input type="number" class="form-control" id="ppn" value="{{ old('ppn') }}" name="ppn" placeholder="Harga tanpa titik (4000)">
                        <span class="text-danger mt-2">@error('ppn'){{ $message }}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="diskon">Diskon</label>
                        <input type="number" class="form-control" id="diskon"  name="diskon" value="{{ old('diskon') }}" placeholder="Tanpa tanda % (50)">
            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    <a href="{{route('admin.buku')}}" class="btn btn-info mb-3 text-white">Refresh</a>
                    <form class="form-inline mb-3 justify-content-end" action="{{route('admin.buku.search')}}" method="POST">
                        @csrf
                ...
                <tbody>
                    ...
                    <td>{{$book->diskon}}</td>
                    <td>
                        <a href="{{ route('admin.buku.edit',$book->id) }}"><img src="/img/edit.svg" width="20"></a>
                    </td>
                    <td>
                        <a href="{{ route('admin.buku.delete',$book->id) }}"><img src="/img/delete.svg" width="20"></a>
                    </td>
                    </tr>
                    @endforeach
                </tbody>
